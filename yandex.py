...
class Yandex:
    ...
    def create_folder(self, folder):
        ...
        response = requests.put('https://cloud-api.yandex.net/v1/disk/resources', headers=HEADERS, params=data)
        return response

    def upload(self, download_folder: str):
        HEADERS = {"Authorization": f"OAuth {self.token}"}
